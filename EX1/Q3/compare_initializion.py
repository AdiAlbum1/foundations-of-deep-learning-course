...
def train_network(net, optimizer, loss_func, epochs, train_data, test_data, init_mode):
  ...
  np.save(f"statistics/results/initialization/results/{init_mode}_stats", np.array([train_loss_per_epoch, test_loss_per_epoch, train_acc_per_epoch, test_acc_per_epoch]))
  print()
...
if __name__ == "__main__":
    ...
    train_network(net, optimizer, loss_func, epochs, train_data, test_data, "random_init")

    # Xavier initialize net
    net.xavier_init()
    train_network(net, optimizer, loss_func, epochs, train_data, test_data, "xavier_init")
