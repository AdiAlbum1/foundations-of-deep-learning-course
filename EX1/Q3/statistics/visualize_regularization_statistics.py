...
if __name__ == "__main__":
    ...
    weight_decay_stats_0 = np.load("statistics/results/regularization/results/regularization_weight_decay_stats_0.npy", allow_pickle=True)
    weight_decay_stats_1 = np.load("statistics/results/regularization/results/regularization_weight_decay_stats_1.npy", allow_pickle=True)
    weight_decay_stats_2 = np.load("statistics/results/regularization/results/regularization_weight_decay_stats_2.npy", allow_pickle=True)
    dropout_stats_0 = np.load("statistics/results/regularization/results/regularization_dropout_stats_0.npy", allow_pickle=True)
    dropout_stats_1 = np.load("statistics/results/regularization/results/regularization_dropout_stats_1.npy", allow_pickle=True)
    dropout_stats_2 = np.load("statistics/results/regularization/results/regularization_dropout_stats_2.npy", allow_pickle=True)
