...
if __name__ == "__main__":
    no_preprocess_stats = np.load("statistics/results/preprocessing/results/without_preprocessing_stats.npy", allow_pickle=True)
    whitened_stats = np.load("statistics/results/preprocessing/results/with_preprocessing_stats.npy", allow_pickle=True)
