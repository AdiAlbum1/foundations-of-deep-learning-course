...
if __name__ == "__main__":
    sgd_stats = np.load("statistics/results/optimization/results/optim_sgd_stats.npy", allow_pickle=True)
    adam_stats = np.load("statistics/results/optimization/results/optim_adam_stats.npy", allow_pickle=True)
