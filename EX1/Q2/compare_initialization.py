...
if __name__ == "__main__":
    ...
    np.save("statistics/results/initialization/results/xavier_init_stats", np.array([train_loss_per_epoch, test_loss_per_epoch, train_acc_per_epoch, test_acc_per_epoch]))
