...
if __name__ == "__main__":
    normal_stats = np.load("statistics/results/initialization/results/normal_init_stats.npy")
    xavier_stats = np.load("statistics/results/initialization/results/xavier_init_stats.npy")
